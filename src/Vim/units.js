  ...
  "lessons": [
    ...
    },
    {
      ...
      "hints": {
        ...
        "text": [
          "The ^, 0, $ keys move within the current line. 0 moves to the first character of the line. ^ will move to the first non-empty character (useful for indented code). $ will move to the end of the current line."
        ],
        "additional": [
